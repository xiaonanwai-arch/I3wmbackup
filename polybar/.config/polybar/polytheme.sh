...
# Source your global applet settings
...
# Present the themes via Rofi (FIXED: Added the -theme flag)
chosen_theme=$(echo "$themes" | rofi -dmenu -i -p "Select Polybar Theme:" -theme "$theme")

# Exit if no theme was chosen
